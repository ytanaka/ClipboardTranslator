    ...
    private View createListItem(LinearLayout parent, final int i) {
        ...
        holder.btDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Util.showOKCancelMsgBox(SettingActivity.this, getString(R.string.explanation_to_user_how_to_download, info.downloadClickTarget), new Runnable() {
                    @Override
                    public void run() {
        ...
        holder.btImport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Util.showOKCancelMsgBox(SettingActivity.this, getString(R.string.explanation_to_user_how_to_import, info.downloadFilename), new Runnable() {
                    @Override
                    public void run() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        for (int i = 0; i < Dic.LIST.length; i++) {
            ...
            new ProgressAsyncTask(SettingActivity.this, getString(R.string.importing_dictionary)) {
                ...
                @Override
                protected void run() {
                    count = dic.extractAndInsertToDb(SettingActivity.this, data.getData(), mDb, notifier);
                }
                @Override
